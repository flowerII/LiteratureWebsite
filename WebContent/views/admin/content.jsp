...
<html>
	...
	<body>
	<% String article_id=request.getParameter("article");
	   Article article=new Article();
	   ArticleService articleService=new ArticleService();
	   article=articleService.getArticleByArticleId(Integer.parseInt(article_id));
	   session.setAttribute("all_id", article_id);
		...
		<div class="container">
			<div class="panel">
				<div class="panel-heading">
					<h3><%=article.getArticle_name() %></h3>
					<p><span><%=article.getUser_name() %></span></p>
				</div>
